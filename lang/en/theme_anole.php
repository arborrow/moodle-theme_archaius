...
/**
 * Strings for component 'theme_anole', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_anole
 * @copyright 2012 onwards Daniel Munera Sanchez  {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['pluginname'] = 'anole';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>anole</h2>                                                                                      
<img src="anole/pix/screenshot.png" />                                                           
...
<div class="theme_description"><h2>About</h2><p>anole is a fluid-width, three-column Moodle 2.x theme with rounded corners and tabs.
...
<p>The anole settings page has multiple options that allow you to customize your site.</p>                                                                                         
<h2>Tweaks</h2><p>If you want to modify this theme, I recommend that you first duplicate it, then rename it before making your changes. This will prevent your customized theme from being overwritten by future Moodle upgrades, and you\'ll still have the original files if you make a mess.                                                                                                                                                                       
More information on modifying themes can be found in the <a href="http://docs.moodle.org/en/Theme">MoodleDocs</a>.</p>                                                               
<h2>Credits</h2><p>This theme is based on anomaly themes, it was originally designed for Moodle 1.9 by Patrick Malley. anole was created by Daniel Munera Sanchez using the open source libraries: jQuery, jQuerytools, PIE.js. He can be contacted at dmunera119@gmail.com</p>
<p>The logo was made by Juan Pablo londono.</p>';
$string['logo'] = 'logo';
