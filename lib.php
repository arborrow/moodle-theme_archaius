...
/*
*
 * Functions needed by the anole theme should be put here.
 *
...
function anole_process_css($css, $theme) {
    ...
    $css = anole_set_customcss($css, $customcss);
    ...
    $css = anole_set_themecolor($css,$themecolor);
    ...
    $css = anole_set_bgcolor($css,$bgcolor);
    ...
    $css = anole_set_headercolor($css,$headercolor);
    ...
    $css = anole_set_currentcolor($css,$currentcolor);
    ...
    $css = anole_set_currentcustommenucolor($css,$currentcustommenucolor);

    return $css;
}

function anole_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
...
function anole_set_customcss($css, $customcss) {
...
function anole_set_customjs($js, $customjs) {
...
function anole_set_theme_collasibleTopics($js, $collasible) {
    $tag = '[[theme_anole/collasibleTopics]]';
...
function anole_set_themecolor($css, $themecolor) {
...
function anole_set_headercolor($css, $headercolor) {
...
function anole_set_currentcolor($css, $currentcolor) {
...
function anole_set_currentcustommenucolor($css, $currentcustommenucolor) {
...
function anole_set_bgcolor($css, $bgcolor) {
  $tag = '[[setting:bgcolor]]';
  $replacement = $bgcolor;
  if (is_null($replacement)) {
    $replacement = '#F5F5F5';
